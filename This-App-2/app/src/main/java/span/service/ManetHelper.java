...
import span.service.core.ManetService;
...
public class ManetHelper {
	...
	private void sendMessage(int what) {
		if(sendMessenger == null) {
			//Log.e("ManetHelper::sendMessage", "You must connect to the ManetService before sending messages to it!");   ESTO LO QUITE YO
			return;
	    	}
		try {
